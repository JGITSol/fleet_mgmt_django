    ...
    <nav class="navbar">
        <div class="container nav-content">
            <a href="{% url 'home' %}" class="nav-logo" aria-label="{% trans 'Home' %}">
                <i class="fas fa-car-side"></i> {% trans "FleetManager" %}
            </a>

            <div class="nav-links">
                <a href="{% url 'home' %}"
                    class="nav-link {% if request.resolver_match.url_name == 'home' %}active{% endif %}">{% trans "Home Page"
                    %}</a>
    ...
    <footer class="footer">
        <div class="container">
            <div class="flex justify-between items-center">
                <div>
                    <h4 style="margin-bottom: 0.5rem;">{% trans "FleetManager" %}</h4>
...
path = r'd:\REPOS\fleet_mgmt_django\CarFleetManagement\templates\base_v2.html'
...
with open(path, 'r', encoding='utf-8') as f:
    read_content = f.read()
    if 'language.code == LANGUAGE_CODE' in read_content and 'Home Page' in read_content:
        print("Verification SUCCESS: Found correct syntax and content.")
    else:
        print("Verification FAILED: Syntax error or content mismatch.")
