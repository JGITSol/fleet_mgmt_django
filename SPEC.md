...
### User Interface
- **Standard**: Follows the `base_v3.html` template inheritance pattern.
- **Design System**: Variable-based theming in `style.css` / `themes.css`.
- **Responsive**: Mobile-first design using custom CSS Flexbox/Grid.

---

Document updated February 2026. Review and adjust permissions, endpoint exposure, and data retention policies to match your organization's compliance requirements.
