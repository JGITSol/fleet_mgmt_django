...
def fix_database_schema():
    ...
    try:
        ...
        if phone_number_exists:
            ...
            cursor.execute("ALTER TABLE accounts_customuser_new RENAME TO accounts_customuser")
        ...
        if not permissions_exists:
            ...
            cursor.execute("ALTER TABLE accounts_userrole ADD COLUMN permissions TEXT DEFAULT '{}'")
