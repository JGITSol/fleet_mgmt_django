...
export function Button_23d73e3c7ed3bf2258bd1944e58e0988 () {
  
  const [addEvents, connectErrors] = useContext(EventLoopContext);


  const on_click_bec43142742d4bc7c00b1b3002cca45e = useCallback(((...args) => (addEvents([(Event("reflex___state____state.pages___vehicles____vehicles_state.fetch_vehicles", ({  }), ({  })))], args, ({  })))), [addEvents, Event])
  ...
  return (
    jsx(
RadixThemesButton,
{onClick:on_click_bec43142742d4bc7c00b1b3002cca45e},
"Load Vehicles"
,)
  )
}
...
"Maintenance"
,),),),),),jsx(Button_23d73e3c7ed3bf2258bd1944e58e0988,{},)
,jsx(
RadixThemesBox,
...
"title",
{},
"CarFleetManagerFrontend | Vehicles"
