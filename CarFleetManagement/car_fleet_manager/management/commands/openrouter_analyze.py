"""Management command to analyze screenshots using OpenRouter API.

This command provides a convenient CLI for using the OpenRouter API
to analyze screenshots and generate reports. It includes rate limiting
...
class Command(BaseCommand):
    ...
    def _handle_analyze(self, options):
        ...
        # Get OpenRouter client and analyze the screenshot
        client = get_client()
