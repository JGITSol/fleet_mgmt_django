...
class EmergencyViewsExtendedTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.admin_role, _ = UserRole.objects.get_or_create(name="ADMIN", defaults={"description": "Admin"})
        self.emergency_role, _ = UserRole.objects.get_or_create(
            name="EMERGENCY_STAFF", defaults={"description": "Emergency Staff"}
        )
        self.driver_role, _ = UserRole.objects.get_or_create(name="DRIVER", defaults={"description": "Driver"})
