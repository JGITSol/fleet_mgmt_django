...
class PermissionsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.admin_role, _ = UserRole.objects.get_or_create(name=UserRole.ADMIN, defaults={"description": "Admin"})
        ...
        self.driver_role, _ = UserRole.objects.get_or_create(name=UserRole.DRIVER, defaults={"description": "Driver"})
